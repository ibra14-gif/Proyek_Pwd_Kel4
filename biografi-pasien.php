...
<body>
   <?php include 'header-pasien.php'; ?>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="doctor-card">
                    ...
                    <div class="doctor-card-footer">
                            <a href="form.php?dokter=<?= $d['id_dokter'] ?>" class="btn btn-green flex-fill">
    ...
    <section class="py-4" style="background:var(--green-100);">
    <div class="container text-center">
        <p class="mb-3 fw-semibold text-green">Sudah menemukan dokter yang tepat? Buat reservasi sekarang!</p>
